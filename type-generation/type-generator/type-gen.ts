...
export class TypeGenerator {
  ...
  generate(schema: ExtendedSchema): string {
    ...
    this.addComments(preparedSchema);
    this.addImports();
    this.addBasicTypes();
  ...
  addComments(preparedSchema: PreparedSchema) {
    this.file.addStatements([
      `// auto generated types for layer ${preparedSchema.layerNumber}`,
      `// see https://github.com/gram-js/docs`,
    ]);
  }
